...
!developmentChains.includes(network.name)
  ...
  : describe("Raffle Unit Tests", () => {
      ...
      describe("enterRaffle", () => {
        ...
        it("records the player when they enter", async () => {
        ...
        it("doesnt allow entrance when raffle is calculating", async () => {
          ...
          //   We Pretend to be the chainlink VRF
      ...
      describe("performUpkeep", () => {
        ...
        it("updates the raffle state, emits and event, and calls teh vrf coordinator", async () => {
          await raffle.enterRaffle({ value: raffleEntranceFee });
          await network.provider.send("evm_increaseTime", [
            interval.toNumber() + 1,
          ]);
      ...
      describe("fulfill RandomWords", () => {
        ...
        it("picks a winner, resets the lottery, and sends the money", async () => {
          ...
          // fufillRandomWords ( mock being the ChainlinkVRF)
